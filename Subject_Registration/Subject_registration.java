...
public class Main extends Application {
    ...
    public void start(Stage FirstStage) {
        ...
        //change of mind make this shit combo box
        ComboBox combo = new ComboBox<>();
        combo.getItems().addAll("Sem 1", "Sem 2", "Short Sem");
        combo.setValue("Sem 1");
        ...
        gridPane.add(Semester_name,0,2);
        ...
        gridPane.add(Submit_subject,0,0,2,50);
